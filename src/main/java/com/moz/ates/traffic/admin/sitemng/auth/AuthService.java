...
public class AuthService {
	...
	/**
	  * @Method Name : getAuthListByNoyEqualToAuthCd
	  * @Date : 2024. 7. 11.
	  * @Author : IK.MOON
	  * @Method Brief : superAdmin 제외 권한 전체 조회
	  * @param mozAuth
	  * @return
	  */
	public List<MozAuth> getAuthListByNoyEqualToAuthCd(MozAuth mozAuth) {
		return mozAuthRepository.findAllMozAuthByNotEqualToAuthCd(mozAuth);
	}
}
